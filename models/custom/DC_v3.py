...
class FrozenDINOv3FeatureExtractor(nn.Module):
    ...
    def __init__(
        ...
        print(
            "[DC_v3] Frozen DINOv3 feature extractor ready. "
    ...
    def _build_dino_backbone(self):
        ...
        if self.dino_ckpt_path is not None and self.dino_ckpt_path != "":
            ...
            print(
                f"[DC_v3] 加载 DINOv3 权重完成: {self.dino_ckpt_path}\n"
...
class DC_v3(nn.Module):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        print(
            "[DC_v3] 构建完成：HL_base + Frozen DINO + LRD-Adapter + H/16 Road-DCA。"
        )
